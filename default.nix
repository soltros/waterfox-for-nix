...
in pkgs.stdenv.mkDerivation rec {
  ...
  # No build phase needed for binary package
  dontBuild = true;
  dontConfigure = true;
...
EOF
    ...
    if [ -f $out/lib/waterfox/browser/chrome/icons/default/default128.png ]; then
      cp $out/lib/waterfox/browser/chrome/icons/default/default128.png $out/share/icons/hicolor/128x128/apps/waterfox.png
    fi
